...
with open('/home/raihan/CPS-VVI-LOGS-DATA/All-new-logs/10.2.everything-logged-with-good/combined-HV-1wpS', 'r') as f:
    input_str = f.read()
...
for i, graph in enumerate(graphs):
    graph.render(f'comb-graph-all_states/combined-graph-{i}.dot')
