...
if __name__ == "__main__":
    ...
    if not os.path.isdir("./sharedPatternRemoved"):
        os.mkdir("./sharedPatternRemoved")
    fout_path = "./sharedPatternRemoved"
    fout_name = f"{args.fnames}_{args.seq_len}_{args.topk}.txt"
    # Open a file for writing
    with open(os.path.join("sharedPatternRemoved/", fout_name), 'w') as file:
        # Redirect the standard output to the file
        original_stdout = sys.stdout
        sys.stdout = file
    
        # Perform your print statements
        print(f"All updated traces -> {function_calls}")
