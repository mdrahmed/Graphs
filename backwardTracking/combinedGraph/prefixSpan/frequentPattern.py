...
if __name__ == "__main__":
    ...
    subsequences = break_into_subsequences_non_overlap(function_calls, args.seq_len, 256)
    ...
    if not os.path.isdir("./meta"):
        os.mkdir("./meta")
    fout_path = "./meta"
    fout_name = f"{args.fname}_{args.seq_len}_{args.min_len}_{args.max_len}_{args.topk}.json"
